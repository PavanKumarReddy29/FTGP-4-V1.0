...
abstract contract currConverter{
    ...
    // Convert fromCurrency to USD-based tokens for minting
    function convert(
        string memory fromCurrency,
        uint256 amount
        ...
        // Convert to USD-based tokens (1 token = 1 USD with 18 decimals)
        tokenAmount = (amount * fromRate)* 10**18; // Adjust for decimals
        return tokenAmount;
    }
